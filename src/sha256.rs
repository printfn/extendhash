...
mod tests {
    ...
    fn a_test() {
        assert_eq!(
            ...
            [
                0xca, 0x97, 0x81, 0x12, 0xca, 0x1b, 0xbd, 0xca, 0xfa,
                0xc2, 0x31, 0xb3, 0x9a, 0x23, 0xdc, 0x4d, 0xa7, 0x86,
                0xef, 0xf8, 0x14, 0x7c, 0x4e, 0x72, 0xb9, 0x80, 0x77,
                0x85, 0xaf, 0xee, 0x48, 0xbb
            ]
        );
    }
    ...
    fn quick_brown_fox_test_2() {
        ...
        assert_eq!(
            sha256::compute_hash(s.as_bytes()),
            [
                0xe4, 0xc4, 0xd8, 0xf3, 0xbf, 0x76, 0xb6, 0x92, 0xde,
    ...
    fn abc_test() {
        ...
        assert_eq!(
            sha256::compute_hash(s.as_bytes()),
            [
                0xdb, 0x4b, 0xfc, 0xbd, 0x4d, 0xa0, 0xcd, 0x85, 0xa6,
                0x0c, 0x3c, 0x37, 0xd3, 0xfb, 0xd8, 0x80, 0x5c, 0x77,
                0xf1, 0x5f, 0xc6, 0xb1, 0xfd, 0xfe, 0x61, 0x4e, 0xe0,
                0xa7, 0xc8, 0xfd, 0xb4, 0xc0
            ]
        );
    }
    ...
    fn long_test() {
        ...
        assert_eq!(
            ...
            [
                0xcd, 0xc7, 0x6e, 0x5c, 0x99, 0x14, 0xfb, 0x92, 0x81,
                0xa1, 0xc7, 0xe2, 0x84, 0xd7, 0x3e, 0x67, 0xf1, 0x80,
                0x9a, 0x48, 0xa4, 0x97, 0x20, 0x0e, 0x04, 0x6d, 0x39,
                0xcc, 0xc7, 0x11, 0x2c, 0xd0
            ]
        );
    }
    ...
    fn test_hash_ext() {
        ...
        let combined_hash =
            sha256::extend_hash(hash, secret.len(), appended_str);
