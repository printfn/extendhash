...
pub fn extend_hash(
    ...
    sha01::extend_hash(
        hash, length, additional_input, sha01::HashType::SHA1)
}
...
mod tests {
    ...
    fn quick_brown_fox_test() {
        ...
        assert_eq!(sha1::compute_hash(s.as_bytes()), [
    ...
    fn padding_length_tests() {
        ...
        assert_eq!(
            sha1::padding_length_for_input_length(64 * 100000),
            64);
    }
    ...
    fn test_hash_ext() {
        ...
        assert_eq!(
            combined_hash,
            sha1::compute_hash(concatenation.as_slice()));
    }
}
